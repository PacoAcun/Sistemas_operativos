...
rm -f root.o main.o os.o p1.elf p1.bin stdio.o string.o
...
arm-none-eabi-ld -T linker.ld -o p1.elf root.o main.o os.o stdio.o string.o

# Convertir el archivo ELF a binario
echo "Convirtiendo ELF a binario..."
arm-none-eabi-objcopy -O binary p1.elf p1.bin
