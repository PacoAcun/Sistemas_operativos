...
reset:
    // Forzar modo Supervisor (SVC) para habilitar interrupciones IRQ
    mrs r0, cpsr
    ...
    ldr sp, =0x82220000     // Configurar stack del proceso
...
clear_bss:
    ldr r0, =__bss_start__  // Fixed symbol name
    ldr r1, =__bss_end__    // Fixed symbol name
    mov r2, #0
bss_clear:
    cmp r0, r1
    strlt r2, [r0], #4
